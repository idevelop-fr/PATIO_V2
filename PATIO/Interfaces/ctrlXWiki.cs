    ...
    public partial class ctrlXWiki : UserControl
    {
        ...
        {/*
            ...
            foreach (DataRow r in ds.Tables["pageSummary"].Rows)
            {
                ...
                if(lv.Liste.Count>0)
                {
                    PATIO.Classes.Version v = lv.Liste[0];
                ...
                {
                    Extraction_Plan(code);
                    PATIO.Classes.Version v = new PATIO.Classes.Version();
        ...
        void CorrigerAction()
        {
           /* lst.Items.Add("Corrections des actions...");
            ...
            foreach( PATIO.Classes.Action a in l.Liste)
            {
                CorrectionCode(a);
            }
       ...
       void CorrectionCode(PATIO.Classes.Action a)
        {
            string code = a.Code;
